    ...
    <footer className="footer-two section pb-0">
      <div className="container">
        <div className="row gaper">
          <div className="col-12 col-lg-5 col-xl-4 offset-xl-1 offset-xxl-3">
            <div className="footer-two__left">
              ...
              <div className="paragraph">
                <p>
                  مرحبًا بكم في الوكالة الرقمية لدينا نحن متخصصون في مساعدة
                  الأعمال التجارية التي تشبه أعمالك على النجاح متصل. من تصميم
                  وتطوير الموقع.
                </p>
              </div>
        ...
        <div className="container">
          <div className="row align-items-center gaper">
            <div className="col-12 col-xl-6">
              <div className="footer__copyright-text text-center text-xl-end">
                <p>
            ...
            <div className="col-12 col-xl-6">
              <ul className="justify-content-center justify-content-xl-end">
                ...
                <li>
                  <Link href="contact-us"> الاتصال </Link>
                </li>
              </ul>
            </div>
          </div>
